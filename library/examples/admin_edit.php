...
if(isset($_POST['edit'])){
	if(!empty($_POST['username']) && !empty($_POST['password']) && !empty($_POST['name']) && !empty($_POST['email'])){
        ...
        $name = $_POST['name'];
		$email = $_POST['email'];
        $updater = $_SESSION['name'];
		
		$update = "Update admin SET username = '".$username."', password = '".$password."', name = '".$name."', email = '".$email."', updated_by = '".$updater."' WHERE id = '".$_GET['id']."'";
                        ...
                        <div class="col-md-8">
                            <div class="card">
                                <div class="card-header" data-background-color="purple">
                                    <h4 class="title">Edit Admin Information</h4>
                                    <p class="category">Complete admin information</p>
                                </div>
                                <div class="card-content">
                                    <form method="post" action="admin_edit.php?id=<?php echo $_GET['id']; ?>">
                                        <div class="row">
                                            <div class="col-md-4">
