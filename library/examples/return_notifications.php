...
$select = "SELECT o.id oid,m.name mname,m.ic mic,b.image bimage,b.name bname,bd.barcode barcode,o.borrow_date borrow_date,o.return_date return_date,o.status ostatus FROM borrow o 
           ...
           WHERE o.status = 'return' AND o.return_date < '".$date."' ".$search." ORDER BY o.borrow_date ASC";
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header" data-background-color="purple">
                                    <h4 class="title">Expired Book List</h4>
                                </div>
                                    ...
                                    <table class="table">
                                        ...
                                        <?php while($row = mysqli_fetch_assoc($result)){ ?>
                                            <tr>
                                                ...
                                                ?>  
                                                <td class="<?=$remider?>"><?php echo $row['return_date'] ?></td>
                                                <td><a class="material-icons" href="checked_return.php?id=<?php echo $row['oid']; ?>">search</a></td>
                                            </tr>
                                        <?php }?>    
                                        </tbody>
                                    </table>
